...
class Product extends Model
{
    ...
    protected $fillable=['id', 'name', 'slug', 'short_description', 'description', 'regular_price', 'sale_price', 'SKU', 'stock_status', 'featured', 'quantity', 'image', 'images', 'category_id', 'active', 'translation_lang', 'translation_of'];
