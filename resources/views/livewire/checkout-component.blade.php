                ...
                <div class="col-md-12">
                    <div class="wrap-address-billing">
                        ...
                        <div class="billing-address">
                            ...
                            {{--firstname	lastname	mobile	email	line1	line2	city	province	country	zipcode--}}
                            <p class="row-in-form">
                                <label for="country">Country<span>*</span></label>
                                <input type="text" name="country" value="" placeholder="Egypt">
                            </p>
                            <p class="row-in-form">
                    ...
                    <div class="col-md-12">
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                <p class="row-in-form">
                                    <label for="firstname">first name<span>*</span></label>
                                    <input type="text" name="firstname" value="" placeholder="Your first name" wire:model="s_firstname">
                                </p>
                                <p class="row-in-form">
                                    <label for="lastname">last name<span>*</span></label>
                                    <input  type="text" name="lastname" value="" placeholder="Your last name" wire:model="s_lastname">
                                </p>
                                <p class="row-in-form">
                                    <label for="email">Email Addreess:</label>
                                    <input type="email" name="email" value="" placeholder="Type your email" wire:model="s_email">
                                </p>
                                {{--line1	line2	city	province	country	zipcode--}}
                                <p class="row-in-form">
                                    <label for="mobile">Phone number<span>*</span></label>
                                    <input type="number" name="mobile" value="" placeholder="10 digits format" wire:model="s_mobile">
                                </p>
                                <p class="row-in-form">
                                    <label for="line1">Line1:</label>
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input type="text" name="line1" value="" placeholder="Street at apartment number" wire:model="s_line2">
                                </p>

                                <p class="row-in-form">
                                    <label for="country">Country<span>*</span></label>
                                    <input type="text" name="country" value="" placeholder="Egypt" wire:model="s_country">
                                </p>
                                <p class="row-in-form">
            ...
            <div class="summary summary-checkout">
                <div class="summary-item payment-method">
                    ...
                    <div class="choose-payment-methods">
                        ...
                        <label class="payment-method">
                            <input name="payment-method" id="card" value="card" type="radio">
