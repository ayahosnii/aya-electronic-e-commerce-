                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.homeslider.store')}}" method="POST"
...
@section('script')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCc8QIF8r6-AX_fOI0Ywrjotxj5n7ZwXqs&libraries=places&callback=initAutocomplete&language=ar&region=EG
         async defer"></script>
         @stop
         --}}
